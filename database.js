(() => {
  ...
  const start=()=>{
    if(started)return; const ctx=window.GHOST_CONTROL_CONTEXT||{kind:"owner",permissions:{all:true}}; if(ctx.kind==="staff"&&ctx.permissions?.operations!==true)return; started=true;
